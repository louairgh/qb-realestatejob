...
--[[ CreateThread(function()
    ...
    -- Load custom blip sprite from the PNG file
    local customSpriteId = RegisterCustomSprite("path/to/factory_blip.png")

    -- Set the loaded custom sprite
    SetBlipSprite(Blip, customSpriteId)
    ...
    AddTextComponentSubstringPlayerName("Factory Blip")
